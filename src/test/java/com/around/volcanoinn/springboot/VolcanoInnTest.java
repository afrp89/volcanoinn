...
@SpringBootTest(classes = VolcanoInnApplication.class)
...
public class VolcanoInnTest {
    ...
    public void aaNoCampsiteIdShouldReturnAllCampsitesAvailability() {
    ...
    @Test
    public void abGetFirstCampsiteAvailabilityBetweenDates() {
    ...
    @Test
    public void acGetNotExistingCampsite() {
    ...
    @Test
    public void adMakeSuccessfulBooking() {
        ...
        Guest guest = new Guest("Diego Lalo", "diego.lalo@gmail.com");
        ...
        assertTrue(booking.getGuest().getEmail().equals("diego.lalo@gmail.com"));
        assertTrue(booking.getGuest().getName().equals("Diego Lalo"));
    ...
    public void aeUpdateBooking() {
        ...
        booking = restTemplate.getForObject(bookingUri, Booking.class);
        Guest bookingGuest = booking.getGuest();
        // Check contents
        assertTrue(booking != null);
        assertTrue(bookingGuest.getEmail().equals(updatedEmail));
        assertTrue(bookingGuest.getName().equals(updatedFullName));
    ...
    @Test
    public void ahTryBookingMoreThanThreeDays() {
    ...
    @Test
    public void aiTryBookingArrivalDateToday() {
    ...
    @Test
    public void ajTryReseveArrivalDateMoreThanOneMonthAhead() {
    ...
    @Test
    public void akTryBookingDepartureDateBeforeArrivalDate() {
